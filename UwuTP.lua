...
defaults.p6.stroke = {}
defaults.p6.flags = {}
defaults.p6.flags.bold = true
defaults.p6.stroke.alpha = 200
defaults.p6.stroke.width = 1
defaults.p6.stroke.red = 0
defaults.p6.stroke.blue = 0
defaults.p6.stroke.green = 50
defaults.p6.pos.x = 1559
defaults.p6.pos.y = 503
defaults.p6.text = {}
defaults.p6.text.font = 'Segoe UI'
defaults.p6.text.size = 11
defaults.p6.text.alpha = 255
defaults.p6.text.red = 119
defaults.p6.text.green = 247
defaults.p6.text.blue = 237
defaults.p6.bg = {}
defaults.p6.bg.alpha = 0
defaults.p6.bg.red = 3
defaults.p6.bg.green = 1
defaults.p6.bg.blue = 1
